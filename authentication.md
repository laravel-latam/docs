...
- [Confirmación de contraseña](#password-confirmation)
    ...
    - [Protegiendo Rutas](#password-confirmation-protecting-routes)
- [Adición de protecciones personalizadas](#adding-custom-guards)
    - [Guardias de solicitud de cierre](#closure-request-guards)
- [Adición de proveedores de usuarios personalizados](#adding-custom-user-providers)
    - [El contrato de proveedor de usuario](#the-user-provider-contract)
    - [El contrato autentificable](#the-authenticatable-contract)
